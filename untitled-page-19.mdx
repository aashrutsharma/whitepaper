...
The case for why this matters to a counselling authority is covered on **What This Looks Like for the People Running It**. This page is the mechanics: what setting up and running an actual round looks like, step by step.
...
Pausing a round, extending a deadline, or rolling back a result that was published in error are all real possibilities, and they're handled as a distinct set of controls rather than something buried in the normal flow above. That's covered next, on **Operational Controls**.
