...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/student w laptop light.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />

  <div>
    ### Step 1: Creating Counselling Profile
  </div>
</div>
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/student w clipboard light.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/STUDENT READING LIGHT.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/student thinking light.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/student w docs light.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/student w id light.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/student bw roads light.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
This is the loop Unnati now goes through, once for JoSAA. A student targeting a medical seat runs through this same loop again on MCC's website. A student wanting a home-state engineering seat runs it a third time on their own state's portal.<br /><br />Which specific bodies run counselling, and what each one actually owns, is covered in full on Counselling Bodies.
