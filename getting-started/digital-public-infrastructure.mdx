...
<img
  src="/images/indiastack_Loog.png"
  alt="Indiastack Loog"
  title="Indiastack Loog"
  className="mx-auto"
  style={{ width:"20%" }}
/>
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/nep.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/apaar.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/abc.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/ndear.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/digilocker.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/dpdp.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/indiaai.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
