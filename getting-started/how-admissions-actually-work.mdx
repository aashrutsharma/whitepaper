...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/exam light.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/counselling light.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '24px', margin: '32px 0'}}>
  <img src="/images/admission light.svg" alt="" style={{width: '96px', height: '96px', flexShrink: 0}} />
