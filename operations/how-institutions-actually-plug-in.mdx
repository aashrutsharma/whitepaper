...
The case for why this matters to an institution is covered on **What This Looks Like for the People Running It**. This page is the other half: the actual mechanics of how an institution's side of this works, step by step.
