---
title: "What an Authority Can Actually See"
...
<div style={{display: 'flex', alignItems: 'center', gap: '12px', margin: '24px 0 8px 0'}}>
  <img src="/images/student w bino light.svg" alt="" style={{width: '32px', height: '32px'}} />

  ## A Live View of the Round
</div>
...
<div style={{display: 'flex', alignItems: 'center', gap: '12px', margin: '24px 0 8px 0'}}>
  <img src="/images/tracking.svg" alt="" style={{width: '32px', height: '32px'}} />
...
<div style={{display: 'flex', alignItems: 'center', gap: '12px', margin: '24px 0 8px 0'}}>
  <img src="/images/alerts.svg" alt="" style={{width: '32px', height: '32px'}} />

  ## Alerts When Something Actually Needs Attention
</div>

<CardGroup cols={2}>
  <Card title="An allocation run fails" color="#070707" icon="flag-off">
  ...
  <Card title="A deadline is approaching with a large gap remaining" icon="badge-x">
